...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/setMilliseconds/index.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/differenceInSeconds/index.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const PomodoroTimer = {
    ...
    init() {
      ...
      const minsEl = mins;
      const secsEl = secs;
      btnEl.addEventListener('click', this.toggleButton.bind({
      ...
      settingsBtnEl.addEventListener('click', this.editTimer.bind(this));
    },
    updateMins(e) {
      const next = e.target;
      this.settings.minutesLimit = isNaN(next.valueAsNumber) ? 0 : next.valueAsNumber;
    },
    updateSecs(e) {
      const next = e.target;
      this.settings.secondsLimit = isNaN(next.valueAsNumber) ? 0 : next.valueAsNumber;
    },
    toggleButton() {
      let btnText = this.btnEl.innerText.toLowerCase();
      if ('start' === btnText) {
        this.countdownStart();
        ...
        this.minsEl.value = this.settings.minutesLimit.toString().padStart(2, '0');
        this.secsEl.value = this.settings.secondsLimit.toString().padStart(2, '0');
      }
    },
    countdownStart: function () {
      let currentTime = new Date();
      currentTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(currentTime, 0);
      let endTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(currentTime, this.settings.minutesLimit);
      endTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(endTime, this.settings.secondsLimit);
      const remainder = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(endTime, currentTime);
      ...
      function timerCallback() {
        ...
        currentTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(currentTime, 0);
        let remainingTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])({
          start: currentTime,
          end: endTime
        });
        const remainingMins = remainingTime.minutes;
        const remainingSecs = remainingTime.seconds;
      ...
      this.settings.timer = setInterval(timerCallback.bind(this), SECOND_IN_MILLISECONDS);
    },
    editTimer: function () {
      const mins = document.getElementById('minutes');
      const secs = document.getElementById('seconds');
